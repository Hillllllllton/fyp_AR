...
const SkullModel = ({ matrix, faceWidth, faceHeight }) => {
  ...
  useEffect(() => {
    if (matrix) {
      ...
      let baseScaleY = faceHeight ? faceHeight / 4.5 : initialY; //for webcam
      // let baseScaleX = faceWidth ? faceWidth / 19 : initialX; //for mobile
      // let baseScaleY = faceHeight ? faceHeight / 16 : initialY; //for mobile
